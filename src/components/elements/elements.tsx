...
export interface CardFilmInterface {
    id: string | undefined;
    name: string;
}
...
const allFilms: PayloadInterface[] = [
    {
        adult: false,
...
export const allGenre: GenreInterface[] = [
    {
        id: 28,
        name: 'боевик',
    },
...
export interface DefaultStateInterface {
    listFilm: PayloadInterface[];
    currentPage: number;
    otherPage: number | null;
    filteredFilms: PayloadInterface[];
    valuePopularity: string;
    genreId: [];
    currentYear: number;
    isAuthorization: boolean;
    currentListFilm: number[];
    watchLater: [];
    favoriteFilms: [];
...
export const defaultState: DefaultStateInterface = {
    ...
    currentPage: 1,
    otherPage: 18,
    valuePopularity: popularityFilmsSort[0],
    currentYear: 2020,
